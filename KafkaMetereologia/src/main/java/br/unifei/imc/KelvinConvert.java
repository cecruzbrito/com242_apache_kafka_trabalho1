...
public class KelvinConvert {
    public static void main(String[] args) {
        ...
        consumer.subscribe(Collections.singletonList("CURRENT_TEMPERATURE"));
        while(true) {
    ...
    private static Properties properties() {
        ...
        properties.setProperty(ConsumerConfig.GROUP_ID_CONFIG, KelvinConvert.class.getSimpleName());
        return properties;
    }
}
